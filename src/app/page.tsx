...
export default function Home() {
  ...
  // Legg til gruppebeskrivelse her 
  const groupDescription = "Skriv din gruppebeskrivelse her. Beskriv gruppens mål, ambisjoner, teknologivalg, og eventuelle samarbeidspartnere...";
