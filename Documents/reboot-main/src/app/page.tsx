...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const progressPercent = Math.max(15, (scrollTop / docHeight) * 100);
      ...
      if (sectionScrollPercent > 80) {
        currentSection = "kontakt";
      } else if (sectionScrollPercent > 65) {
        currentSection = "produkt";
      } else if (sectionScrollPercent > 50) {
        currentSection = "about";
      } else if (sectionScrollPercent > 20) {
        currentSection = "team";
      } else {
        currentSection = "hjem";
      }
